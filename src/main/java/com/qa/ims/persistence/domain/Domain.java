...
public enum Domain {
	...
	CUSTOMER("Information about customers"), ITEM("Individual Items"), ORDER("order of customers"),
	ORDERINFO("Purchases of items from customers"),STOP("To close the application") ;
